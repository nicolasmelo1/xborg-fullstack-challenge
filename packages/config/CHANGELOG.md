...
- 09e08a5: Just to see if it's correctly working
- 9faf4dd: Added tests for the existing endpoints of the backend, will add tests for existing endpoints from the FE as well
